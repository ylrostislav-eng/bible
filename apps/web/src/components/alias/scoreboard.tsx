...
export function AliasHandoffScreen({
  ...
  return (
    <div className="mx-auto flex min-h-[var(--app-height)] max-w-md flex-col gap-6 px-4 pb-[calc(var(--safe-bottom)+1.5rem)] pt-[calc(var(--safe-top)+2rem)]">
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center">
        ...
        {/* Управление показываем именно здесь: в раунде читать инструкции
            уже некогда.

            Раньше тут был описан свайп — и только он, хотя играли кнопками.
            Подсказка читалась как «играть надо свайпом», игрок искал жест
            вместо того, чтобы нажать. Сам свайп потом убрали совсем:
            вертикальный жест в мини-приложении принадлежит Telegram, им
            сворачивают окно, и до экрана он доходит не всегда. Осталась
            одна дорога к действию — кнопки, и описана здесь именно она. */}
        <p className="mt-1 text-xs text-text-muted">
          Внизу экрана: справа — угадали, слева — пропуск
        </p>
      </div>
