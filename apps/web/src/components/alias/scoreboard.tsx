    ...
    <div className="mx-auto flex min-h-[100dvh] max-w-md flex-col gap-6 px-4 pb-6 pt-8">
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center">
        ...
        {/* Управление показываем именно здесь: в раунде читать инструкции
            ...
            Раньше тут был описан свайп — и только он, хотя играют кнопками
            внизу экрана, а свайп лишь короткий путь для тех, кто его нашёл.
            Подсказка читалась как «играть надо свайпом», и человек искал
            жест вместо того, чтобы нажать. Описываем то, чем играют. */}
