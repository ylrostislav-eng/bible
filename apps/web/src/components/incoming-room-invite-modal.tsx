 ...
 * Stays quiet while a game is already in progress, and while sitting on the
 * room screen itself, since that page already shows its own inline list.
 */
export function IncomingRoomInviteModal() {
  ...
  if (activeGame || pathname === '/play/room') return null;
