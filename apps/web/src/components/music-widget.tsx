...
export function MusicWidget() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="app-edge-left glass fixed bottom-[calc(var(--safe-bottom)+6rem)] z-30 flex h-14 w-14 items-center justify-center rounded-full text-text-primary"
      >
  ...
  return (
    <div className="app-edge-left fixed bottom-[calc(var(--safe-bottom)+6rem)] z-30 w-64 rounded-2xl border border-border bg-surface p-4 shadow-2xl">
