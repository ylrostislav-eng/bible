...
export interface StreakSummary {
  ...
  /**
   * Сколько «хранителей серии» из лавки истрачено этой игрой, чтобы
   * закрыть пропущенные дни. Ноль в обычном случае.
   *
   * Экран результата говорит об этом вслух: списание, о котором не
   * сказали, выглядит пропажей — серия цела, а хранителей стало меньше, и
   * связь между этими двумя фактами игроку взяться неоткуда.
   */
  freezesSpent: number;
}
