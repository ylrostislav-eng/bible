...
/**
 * Подсказки под категориями на экране настройки. У `IDIOM` она длиннее
 * прочих намеренно: категория выглядит как поблажка для незнающих, а на
 * деле это самая весёлая часть колоды — объяснять «козла отпущения», не
 * называя ни козла, ни отпущение, сложнее, чем любую притчу.
 */
