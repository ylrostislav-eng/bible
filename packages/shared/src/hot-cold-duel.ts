 ...
 * обоим, кончить её нечем — разве что сдаться или уйти. Тридцать слов —
 * это партия минут на десять, и ровно та длина, после которой человек
 * либо нащупал тему, либо уже ходит по кругу.
 *
 ...
 * одиночной игре.
 */
export const HOT_COLD_DUEL_MAX_GUESSES = 30;
 ...
 * больше нельзя, надо писать. Двадцать секунд — это успеть подумать и
 * набрать, но не успеть уйти заваривать чай.
 *
 ...
 */
export const HOT_COLD_DUEL_SECONDS_PER_GUESS = 20;
