...
- ✅ Рейтинг — таблица лидеров по общему рейтингу с указанием своего места.
- ✅ Изучение (этап 1 — читалка): полный текст Библии (Синодальный перевод),
  навигация по книгам и главам. Дальше в этом режиме — проверочные вопросы
  по главам, серии дней подряд (streak) и планы чтения.
- ⏳ Далее — друзья, планы чтения и проверочные вопросы, комнаты, турниры
